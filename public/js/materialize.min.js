...
function _classCallCheck(t, e) {
              ...
              var x = l[y],
                ...
                var S = !1;if (c.display !== n && null !== c.display && "none" !== c.display) {
                  ...
                  if ("element" !== A) {
                    var O,
                        _ = x[A],
                        E = v.isString(_.easing) ? b.Easings[_.easing] : _.easing;if (1 === g) O = _.endValue;else {
                      var M = _.endValue - _.startValue;if (O = _.startValue + M * E(g, c, M), !f && O === _.currentValue) continue;
                    }if (_.currentValue = O, "tween" === A) m = O;else {
                      if (k.Hooks.registered[A]) {
                        var I = k.Hooks.getRoot(A),
                            D = r(T).rootPropertyValueCache[I];D && (_.rootPropertyValue = D);
                      }var V = k.setPropertyValue(T, A, _.currentValue + (0 === parseFloat(O) ? "" : _.unitType), _.rootPropertyValue, _.scrollData);k.Hooks.registered[A] && (r(T).rootPropertyValueCache[I] = k.Normalizations.registered[I] ? k.Normalizations.registered[I]("extract", null, V[1]) : V[1]), "transform" === V[0] && (S = !0);
                    }
                  }
          ...
          function t() {
              ...
              function d(t, e) {
                ...
                var M;r(a).tweensContainer && !0 === r(a).isAnimating && (M = r(a).tweensContainer), p.each(m, function (t, e) {
                  ...
                  var q = d(m[V]),
                      z = q[0],
                      H = q[1],
                      L = q[2];V = k.Names.camelCase(V);var j = k.Hooks.getRoot(V),
                      $ = !1;if (r(a).isSVG || "tween" === j || !1 !== k.Names.prefixCheck(j)[1] || k.Normalizations.registered[j] !== n) {
                    (s.display !== n && null !== s.display && "none" !== s.display || s.visibility !== n && "hidden" !== s.visibility) && /opacity|filter/.test(V) && !L && 0 !== z && (L = 0), s._cacheValues && M && M[V] ? (L === n && (L = M[V].endValue + M[V].unitType), $ = r(a).rootPropertyValueCache[j]) : k.Hooks.registered[V] ? L === n ? ($ = k.getPropertyValue(a, j), L = k.getPropertyValue(a, V, $)) : $ = k.Hooks.templates[j][1] : L === n && (L = k.getPropertyValue(a, V));var N,
                        W,
                        F,
                        Q = !1;if (N = h(V, L), L = N[0], F = N[1], N = h(V, z), z = N[0].replace(/^([+-\/*])=/, function (t, e) {
                      return Q = e, "";
                      ...
                      o = o || function () {
                      ...
                      }();var X = /margin|padding|left|right|width|text|word|letter/i.test(V) || /X$/.test(V) || "x" === V ? "x" : "y";switch (F) {case "%":
                        ...
                        z = L - z;break;case "*":
                        z *= L;break;case "/":
                        z = L / z;}l[V] = { rootPropertyValue: $, startValue: L, currentValue: L, endValue: z, unitType: W, easing: H }, b.debug && console.log("tweensContainer (" + V + "): " + JSON.stringify(l[V]), a);
            ...
            w ? (m = arguments[0].properties || arguments[0].p, y = arguments[0].options || arguments[0].o) : (m = arguments[h], y = arguments[h + 1]);var C = f.length,
                ...
                if (!p.isPlainObject(m) || v.isEmptyObject(m)) {
                  if (v.isString(m) && b.Redirects[m]) {
                    var _ = (q = p.extend({}, y)).duration,
                        E = q.delay || 0;return !0 === q.backwards && (f = p.extend(!0, [], f).reverse()), p.each(f, function (t, e) {
              ...
              v.isNode(e) && o.call(e);
                ...
                q = p.extend({}, b.defaults, y);if (q.loop = parseInt(q.loop), V = 2 * q.loop - 1, q.loop) for (var z = 0; V > z; z++) {
              var H = { delay: q.delay, progress: q.progress };z === V - 1 && (H.display = q.display, H.visibility = q.visibility, H.complete = q.complete), x(f, "reverse", H);
            }return t();
          }
  ...
  function o(t, e, i) {
    ...
    var i = t.session,
        n = e.pointers,
        o = n.length;i.firstInput || (i.firstInput = E(e)), o > 1 && !i.firstMultiple ? i.firstMultiple = E(e) : 1 === o && (i.firstMultiple = !1);var a = i.firstInput,
        r = i.firstMultiple,
        s = r ? r.center : a.center,
        l = e.center = M(n);e.timeStamp = ht(), e.deltaTime = e.timeStamp - a.timeStamp, e.angle = q(s, l), e.distance = V(s, l), O(i, e), e.offsetDirection = D(e.deltaX, e.deltaY), e.scale = r ? H(r.pointers, n) : 1, e.rotation = r ? z(r.pointers, n) : 0, _(i, e);var c = t.element;v(e.srcEvent.target, c) && (c = e.srcEvent.target), e.target = c;
  }function O(t, e) {
    var i = e.center,
        n = t.offsetDelta || {},
        o = t.prevDelta || {},
    ...
    var n = e.createEvent("Event");n.initEvent(t, !0, !0), n.gesture = i, i.target.dispatchEvent(n);
      ...
      Dt = Mt | It,
      Vt = ["x", "y"],
      qt = ["clientX", "clientY"];T.prototype = { handler: function handler() {}, init: function init() {
      ...
      var e = zt[t.type];e & xt && 0 === t.button && (this.pressed = !0), e & Ct && 1 !== t.which && (e = Tt), this.pressed && this.allow && (e & Tt && (this.pressed = !1), this.callback(this.manager, e, { pointers: [t], changedPointers: [t], pointerType: wt, srcEvent: t }));
      ...
      var e = this.options,
          ...
          o = t.direction,
          a = t.deltaX,
          r = t.deltaY;return o & e.direction || (e.direction & Mt ? (o = 0 === a ? Pt : 0 > a ? At : Ot, i = a != this.pX, n = Math.abs(t.deltaX)) : (o = 0 === r ? Pt : 0 > r ? _t : Et, i = r != this.pY, n = Math.abs(t.deltaY))), t.direction = o, i && n > e.threshold && o & e.direction;
      ...
      var e = this.options,
        ...
        if (t.eventType != Tt) return this.failTimeout();var r = !this.pTime || t.timeStamp - this.pTime < e.interval,
            s = !this.pCenter || V(this.pCenter, t.center) < e.posThreshold;if (this.pTime = t.timeStamp, this.pCenter = t.center, s && r ? this.count += 1 : this.count = 1, this._input = t, 0 === this.count % e.taps) return this.hasRequireFailures() ? (this._timer = o(function () {
          this.state = re, this.tryEmit();
  ...
  var e = { opacity: .5, inDuration: 250, outDuration: 250, ready: void 0, complete: void 0, dismissible: !0, startingTop: "4%", endingTop: "10%" },
    ...
    function i(e, n) {
      _classCallCheck(this, i), e[0].M_Modal && e[0].M_Modal.destroy(), this.$el = e, this.options = t.extend({}, i.defaults, n), this.isOpen = !1, this.$el[0].M_Modal = this, this.id = e.attr("id"), this.openingTrigger = void 0, this.$overlay = t('<div class="modal-overlay"></div>'), i._increment++, i._count++, this.$overlay[0].style.zIndex = 1e3 + 2 * i._increment, this.$el[0].style.zIndex = 1e3 + 2 * i._increment + 1, this.setupEventHandlers();
    }return _createClass(i, [{ key: "getInstance", value: function value() {
        return this;
        ...
        var e = this;t.extend(this.$el[0].style, { display: "block", opacity: 0 }), t.extend(this.$overlay[0].style, { display: "block", opacity: 0 }), Vel(this.$overlay[0], { opacity: this.options.opacity }, { duration: this.options.inDuration, queue: !1, ease: "easeOutCubic" });var i = { duration: this.options.inDuration, queue: !1, ease: "easeOutCubic", complete: function complete() {
        ...
        var t = this;Vel(this.$overlay[0], { opacity: 0 }, { duration: this.options.outDuration, queue: !1, ease: "easeOutQuart" });var e = { duration: this.options.outDuration, queue: !1, ease: "easeOutCubic", complete: function complete() {
      ...
      } }], [{ key: "init", value: function value(e, n) {
    ...
    return i.prototype[e] ? "get" === e.slice(0, 3) ? this.first()[0].M_Modal[e]() : this.each(function () {
      this.M_Modal[e]();
    }) : "object" != (typeof e === "undefined" ? "undefined" : _typeof(e)) && e ? void t.error("Method " + e + " does not exist on jQuery.modal") : (i.init(this, arguments[0]), this);
  };
}(jQuery), function (t) {
      ...
      var i = { onShow: null, swipeable: !1, responsiveThreshold: 1 / 0 };e = t.extend(i, e);var n = Materialize.objectSelectorString(t(this));return this.each(function (i) {
        var o,
          ...
          return Math.floor(t.position().left + u.scrollLeft());
            ...
            w = function w(t) {
          m - t >= 0 ? (s.velocity({ right: y(o) }, { duration: 300, queue: !1, easing: "easeOutQuad" }), s.velocity({ left: b(o) }, { duration: 300, queue: !1, easing: "easeOutQuad", delay: 90 })) : (s.velocity({ left: b(o) }, { duration: 300, queue: !1, easing: "easeOutQuad" }), s.velocity({ right: y(o) }, { duration: 300, queue: !1, easing: "easeOutQuad", delay: 90 }));
          ...
          var e = t(Materialize.escapeHash(this.hash));e.addClass("carousel-item"), f = f.add(e);
            ...
            if (!g) {
              var i = m;m = r.index(t), o.removeClass("active"), (o = p.eq(m)).addClass("active"), w(i), "function" == typeof e.onShow && e.onShow.call(u[0], a);
            }
          ...
          if (t(this).parent().hasClass("disabled")) i.preventDefault();else if (!t(this).attr("target")) {
            g = !0, h = u.width(), v = Math.max(h, u[0].scrollWidth) / p.length, o.removeClass("active");var n = a;o = t(this), a = t(Materialize.escapeHash(this.hash)), p = u.find("li.tab a");o.position();o.addClass("active"), prev_index = m, (m = p.index(t(this))) < 0 && (m = 0), e.swipeable ? f.length && f.carousel("set", m, function () {
  ...
  var e = { displayLength: 1 / 0, inDuration: 300, outDuration: 375, className: void 0, completeCallback: void 0, activationPercent: .8 },
    ...
    function i(e, n, o, a) {
      if (_classCallCheck(this, i), e) {
        this.options = { displayLength: n, className: o, completeCallback: a }, this.options = t.extend({}, i.defaults, this.options), this.message = e, this.panning = !1, this.timeRemaining = this.options.displayLength, 0 === i._toasts.length && i._createContainer(), i._toasts.push(this);var r = this.createToast();r.M_Toast = this, this.el = r, this._animateIn(), this.setTimer();
      }
    }return _createClass(i, [{ key: "createToast", value: function value() {
        var e = document.createElement("div");if (e.classList.add("toast"), this.options.className) {
          var n = this.options.className.split(" "),
              o = void 0,
              a = void 0;for (o = 0, a = n.length; o < a; o++) {
            e.classList.add(n[o]);
          }
        }return ("object" == (typeof HTMLElement === "undefined" ? "undefined" : _typeof(HTMLElement)) ? this.message instanceof HTMLElement : this.message && "object" == _typeof(this.message) && null !== this.message && 1 === this.message.nodeType && "string" == typeof this.message.nodeName) ? e.appendChild(this.message) : this.message instanceof jQuery ? t(e).append(this.message) : e.innerHTML = this.message, i._container.appendChild(e), e;
        ...
        if (e.target && t(e.target).closest(".toast").length) {
          var n = t(e.target).closest(".toast")[0].M_Toast;n.panning = !0, i._draggedToast = n, n.el.classList.add("panning"), n.el.style.transition = null, n.startingXPos = i._xPos(e), n.time = Date.now(), n.xPos = i._xPos(e);
        }
      } }, { key: "_onDragMove", value: function value(t) {
        if (i._draggedToast) {
          t.preventDefault();var e = i._draggedToast;e.deltaX = Math.abs(e.xPos - i._xPos(t)), e.xPos = i._xPos(t), e.velocityX = e.deltaX / (Date.now() - e.time), e.time = Date.now();var n = e.xPos - e.startingXPos,
              o = e.el.offsetWidth * e.options.activationPercent;e.el.style.transform = "translateX(" + n + "px)", e.el.style.opacity = 1 - Math.abs(n / o);
        }
      } }, { key: "_onDragEnd", value: function value(t) {
        if (i._draggedToast) {
          var e = i._draggedToast;e.panning = !1, e.el.classList.remove("panning");var n = e.xPos - e.startingXPos,
              o = e.el.offsetWidth * e.options.activationPercent;Math.abs(n) > o || e.velocityX > 1 ? (e.wasSwiped = !0, e.remove()) : (e.el.style.transition = "transform .2s, opacity .2s", e.el.style.transform = null, e.el.style.opacity = null), i._draggedToast = null;
        }
    ...
    function p() {
      ...
      T.$root.on({ keydown: m, focusin: function focusin(t) {
        ...
        var e = t(this),
            ...
            o = r();o = o && (o.type || o.href), (n || o && !t.contains(T.$root[0], o)) && T.$root.eq(0).focus(), !n && i.nav ? T.set("highlight", T.component.item.highlight, { nav: i.nav }) : !n && "pick" in i ? (T.set("select", i.pick), w.closeOnSelect && T.close(!0)) : i.clear ? (T.clear(), w.closeOnSelect && T.close(!0)) : i.close && T.close(!0);
      }), o(T.$root[0], "hidden", !0);
    }function v() {
  ...
  function i(t, e) {
    ...
    var e = this,
      ...
      var a = i.showMonthsShort ? i.monthsShort : i.monthsFull;return "short_months" == o && (a = i.monthsShort), i.selectMonths && void 0 == o ? n.node("select", n.group({ min: 0, max: 11, i: 1, node: "option", item: function item(t) {
        ...
        v = function v(o) {
      var a = l.year,
          r = !0 === i.selectYears ? 5 : ~~(i.selectYears / 2);if (r) {
        var s = u.year,
            c = d.year,
            p = a - r,
            h = a + r;if (s > p && (h += s - p, p = s), c < h) {
          var f = p - s,
              v = h - c;p -= f > v ? v : f, h = c;
        }if (i.selectYears && void 0 == o) return n.node("select", n.group({ min: p, max: h, i: 1, node: "option", item: function item(t) {
  ...
  function t(t) {
    ...
    function l(t, e) {
      var i = d.offset(),
        ...
        }, 200);_.setHand(l, c, !e, !0), s.off(h).on(h, function (t) {
          t.preventDefault();var e = /^touch/.test(t.type),
              i = (e ? t.originalEvent.touches[0] : t).pageX - o,
              n = (e ? t.originalEvent.touches[0] : t).pageY - a;(p || i !== l || n !== c) && (p = !0, _.setHand(i, n, !1, !0));
        }), s.off(f).on(f, function (t) {
          s.off(f), t.preventDefault();var i = /^touch/.test(t.type),
              n = (i ? t.originalEvent.changedTouches[0] : t).pageX - o,
              u = (i ? t.originalEvent.changedTouches[0] : t).pageY - a;(e || p) && n === l && u === c && _.setHand(n, u), "hours" === _.currentView ? _.toggleView("minutes", x / 2) : r.autoclose && (_.minutesView.addClass("clockpicker-dial-out"), setTimeout(function () {
            _.done();
        ...
        _ = this;this.id = i("cp"), this.element = n, this.holder = v, this.options = r, this.isAppended = !1, this.isShown = !1, this.currentView = "hours", this.isInput = P, this.input = A, this.label = O, this.popover = u, this.plate = d, this.hoursView = m, this.minutesView = T, this.amPmBlock = S, this.spanHours = u.find(".clockpicker-span-hours"), this.spanMinutes = u.find(".clockpicker-span-minutes"), this.spanAmPm = u.find(".clockpicker-span-am-pm"), this.footer = u.find(".picker__footer"), this.amOrPm = "PM", r.twelvehour && (r.ampmclickable ? (this.spanAmPm.empty(), a('<div id="click-am">AM</div>').on("click", function () {
    ...
    var i = !1;"minutes" === t && "visible" === a(this.hoursView).css("visibility") && (o(this.options.beforeHourSelect), i = !0);var n = "hours" === t,
        ...
        s = n ? this.minutesView : this.hoursView;this.currentView = t, this.spanHours.toggleClass("text-primary", n), this.spanMinutes.toggleClass("text-primary", !n), s.addClass("clockpicker-dial-out"), r.css("visibility", "visible").removeClass("clockpicker-dial-out"), this.resetClock(e), clearTimeout(this.toggleViewTimer), this.toggleViewTimer = setTimeout(function () {
    ...
    var r,
        ...
        p = this.options,
        h = l && d < (y + b) / 2,
        f = h ? b : y;if (p.twelvehour && (f = y), s < 0 && (s = 2 * Math.PI + s), r = Math.round(s / u), s = r * u, p.twelvehour ? l ? 0 === r && (r = 12) : (n && (r *= 5), 60 === r && (r = 0)) : l ? (12 === r && (r = 0), r = h ? 0 === r ? 12 : r : 0 === r ? 0 : r + 12) : (n && (r *= 5), 60 === r && (r = 0)), this[this.currentView] !== r && v && this.options.vibrate && (this.vibrateTimer || (navigator[v](10), this.vibrateTimer = setTimeout(a.proxy(function () {
    ...
    var e = Array.prototype.slice.call(arguments, 1);return this.each(function () {
      var i = a(this),
        ...
        var r = a.extend({}, n.DEFAULTS, i.data(), "object" == (typeof t === "undefined" ? "undefined" : _typeof(t)) && t);i.data("clockpicker", new n(i, r));
      }
    });
  };
}(), function (t) {
      ...
      var i = { duration: 200, dist: -100, shift: 0, padding: 0, fullWidth: !1, indicators: !1, noWrap: !1, onCycleTo: null };e = t.extend(i, e);var n = Materialize.objectSelectorString(t(this));return this.each(function (i) {
        function o(t) {
          ...
          _ = !0, j.hasClass("scrolling") || j.addClass("scrolling"), null != H && window.clearTimeout(H), H = window.setTimeout(function () {
            ...
            var p = w % C,
                h = z.find(".indicator-item.active");h.index() !== p && (h.removeClass("active"), z.find(".indicator-item").eq(p).addClass("active"));
            ...
            var f = j.find(".carousel-item").eq(r(w));e.onCycleTo.call(this, f, V);
          ...
          if (V) return i.preventDefault(), i.stopPropagation(), !1;if (!e.fullWidth) {
          ...
          var e, i;if (k) if (e = o(t), y = a(t), i = T - e, Math.abs(S - y) < 30 && !q) (i > 2 || i < -2) && (V = !0, T = e, s(b + i));else {
            if (V) return t.preventDefault(), t.stopPropagation(), !1;q = !0;
          ...
          var e = t + "Transform";return void 0 === document.body.style[e] || (E = e, !1);
      ...
      return this.each(function () {
        var i = t("#" + t(this).attr("data-activates")),
          ...
          var e = "fixed" === i.css("position");if (!e) for (var r = i.parents(), l = 0; l < r.length && !(e = "fixed" == t(r[l]).css("position")); l++) {}var c = i.outerWidth(),
              ...
              q = C / 2 - V / 2,
              z = x / 2 - D / 2,
              H = {};H.top = b ? T : "", H.right = y ? h - S - x : "", H.bottom = w ? f - T - C : "", H.left = g ? S : "", H.position = P, o.css(H), s.css({ width: A, height: O, top: _, right: 0, bottom: 0, left: E, padding: M, verticalAlign: I }), a.css({ top: q, left: z, width: D, height: V });
